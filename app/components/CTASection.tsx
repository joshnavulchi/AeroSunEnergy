  ...
  return (
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          className="relative overflow-hidden rounded-2xl shadow-2xl md:border md:border-slate-200 bg-slate-950 px-6 py-10 dark:border-white/10 sm:px-8 lg:px-10"
        ...
        >
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1fr_280px] lg:items-end">
            <div>
              <span className="inline-block rounded-full md:border md:border-white/16 bg-white/8 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.34em] text-white/72 backdrop-blur-md sm:text-md">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a
                  href="#contact"
                  className="inline-flex items-center rounded-full bg-accent px-8 py-3.5 text-md font-bold text-slate-950 transition-transform duration-200 hover:scale-[1.02]"
                >
                  Request a Free Quote
                </a>
                <a
                  href="#how-it-works"
                  className="inline-flex items-center rounded-full border border-white/18 bg-white/8 px-8 py-3.5 text-md font-bold text-white backdrop-blur-md transition-colors duration-200 hover:bg-white/14"
                >
                  See How It Works
                </a>
              </div>
